...
public class SearchAndDeleteNode {
    ...
    public static class ListNode {
        ...
        public static void main(String[] args) {
            SearchAndDeleteNode lists = new SearchAndDeleteNode();
...
//            lists.head.next.next = new ListNode(30);
        ...
        private static void search(SearchAndDeleteNode lists, int data) {
    ...
    private void pop(ListNode node, SearchAndDeleteNode lists) {
